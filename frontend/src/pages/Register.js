...
const Register = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      setError(language === 'en' ? 'Registration failed' : 'पंजीकरण विफल');
    } finally {
      setLoading(false);
    }
  };
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-amber-50 to-green-50 flex items-center justify-center py-12 px-4 sm:px-6 lg:px-8" data-testid="register-page">
      <div className="max-w-md w-full space-y-8 bg-white p-8 rounded-lg shadow-lg">
        ...
        <form className="mt-8 space-y-6" onSubmit={handleSubmit}>
          ...
          <div className="space-y-4">
            ...
            <div>
              <label htmlFor="confirmPassword" className="block text-sm font-medium text-gray-700">
                {language === 'en' ? 'Confirm Password' : 'पासवर्ड पुष्टि करें'}
              </label>
              <input
                id="confirmPassword"
          ...
          <div>
            ...
            >
              {loading ? '...' : (language === 'en' ? 'Register' : 'पंजीकृत करें')}
            </button>
          </div>
          ...
          <div className="text-center">
            ...
            {' '}
            <Link to="/login" className="text-amber-900 hover:text-amber-800 font-medium" data-testid="login-link">
